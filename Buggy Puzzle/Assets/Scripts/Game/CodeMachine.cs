...
public class CodeMachine : MonoBehaviour
{
    ...
    Vector2[] spawnPoints = {new Vector2(-16.4f,-9.6f), new Vector2(0.4f,-9.6f), new Vector2(16.4f,-9.6f), new Vector2(16.4f, 9.6f), new Vector2(17.2f,-9.6f), new Vector2(16.4f,9.6f), new Vector2(16.4f,9.6f), new Vector2(-16.4f,-9.6f), new Vector2(16.4f, 0f), new Vector2(16.4f,9.6f)};
